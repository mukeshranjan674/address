...
public class AddressBookMain {
	...
	public Map<String,AddressBookMain> addressBooks() {
		
		public Map<String, AddressBookMain> addressBooks = new TreeMap<>();
		
		while(true) {
			System.out.println("Enter name of the Address Book");
			String name = sc.next();
			AddressBookMain m = new AddressBookMain();
			addressBooks.put(name,m);
			System.out.println("Want to add more (y/n)");
			String resposne = sc.next();
	...
	public static void main(String[] args) {
		...
		Map<String,AddressBookMain>add = a.addressBooks();
